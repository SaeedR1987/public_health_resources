  ...
  public = list(
    ...
    initialize = function(data = NULL,
      ...
      if (length(msg_parts) > 0) {
        ...
        iphra_message(
          iphra_txt(glue::glue("{dataset_name} initialized as MortalityDataAnalytics object."))
        )
      }
    },
    ...
    #' @description Load the default Mortality unified outputs schema from template file
    #' @return A list of Mortality-specific outputs definitions (quality and analysis combined)
    ...
    #' @description Load the default Mortality analysis schema from template file
